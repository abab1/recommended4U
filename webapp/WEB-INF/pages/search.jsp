        ...
        <div id="navbar" class="navbar-collapse collapse">
          <form class="navbar-form navbar-right">
            <div class="form-group">
              <input type="text" id="searchbox" name="search" class="form-control " style="width:400px !important;" />
            </div>
            
            <input type="button" id="search-submit" class="btn btn-primary form-control" value="Search" />
...
function fetchReviews(asin) {
	...
	if (data) {
	  ...
	  '<div class="panel-body">Credibility Rating : '+data.actualScore+'</div>'+
	  '<div class="panel-body">Generated Title : '+data.finalScore+'</div>'+
...
function search(queryString) {
	...
	$.ajax({
    type: "GET",
    url: "http://localhost:8080/recommended4U/rest/recommendations/search/"+queryString+","+userEmailId,
    contentType: "application/json; charset=utf-8",
    accept : "text/html",
    async: false,
    timeout: 120000,
...
//$("#loadDiv").hide();
	...
	$("#multiple_slides_visible").agile_carousel({
		...
		persistent_content: "<p class='persistent_content'>Search Results</p>"       
	});
}
